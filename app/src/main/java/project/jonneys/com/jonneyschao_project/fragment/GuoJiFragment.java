...
public class GuoJiFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=guoji&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.guojifragment, container, false);
		listView = (RefreshListView) view.findViewById(R.id.listview_guoji);
		tv = (TextView) view.findViewById(R.id.tv_guoji);
		iv = (ImageView) view.findViewById(R.id.iv_guoji);
		initData();
		return view;
	}
