...
public class ShiShangFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=shishang&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.shishangfragment, container, false);
		listView = (RefreshListView) view.findViewById(R.id.listview_shishang);
		tv = (TextView) view.findViewById(R.id.tv_shishang);
		iv = (ImageView) view.findViewById(R.id.iv_shishang);
		initData();
		return view;
	}
