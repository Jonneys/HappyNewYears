...
public class KeJiFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=keji&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.kejifragment, container, false);
		listView = (RefreshListView) view.findViewById(R.id.listview_keji);
		tv = (TextView) view.findViewById(R.id.tv_keji);
		iv = (ImageView) view.findViewById(R.id.iv_keji);
		initData();
		return view;
	}
