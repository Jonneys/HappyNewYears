...
public class CaiJingFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=caijing&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.caijingfragment, container, false);
		listView = (RefreshListView) view.findViewById(R.id.listview_caijing);
		tv = (TextView) view.findViewById(R.id.tv_caijing);
		iv = (ImageView) view.findViewById(R.id.iv_caijing);
		initData();
		return view;
	}
