...
public class YuLeFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=yule&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	private RefreshListView listView;
	private List<Data> data;
//	private ListViewAdapter_KeJi adapter =  new ListViewAdapter_KeJi(data, getActivity());
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.yulefragment, container, false);
		listView = (RefreshListView) view.findViewById(R.id.listview_yule);
		tv = (TextView) view.findViewById(R.id.tv_yule);
		iv = (ImageView) view.findViewById(R.id.iv_yule);
