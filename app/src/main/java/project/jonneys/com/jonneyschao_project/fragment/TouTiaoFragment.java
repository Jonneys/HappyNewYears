...
public class TouTiaoFragment extends NewFragment {
	public static final String PATH = "http://v.juhe.cn/toutiao/index?type=top&key=99d065aebbf5a152d7f81f509aaf3e91";
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.toutiaofragment, container, false);
		tv = (TextView) view.findViewById(R.id.tv_toutiao);
		listView = (RefreshListView) view.findViewById(R.id.listview_top);
		iv = (ImageView) view.findViewById(R.id.iv_toutiao);
		initData();
		return view;
	}
